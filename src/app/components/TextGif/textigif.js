        ...
        <div className="section sec-halfs py-0">
          <div className="half-content d-lg-flex align-items-stretch justify-content-evenly">
            ...
            <div className="text d-flex flex-column col-xs-12 col-md-6 justify-content-center ms-lg-5">
              ...
              <p className="mb-5">
                Each relationship revolves around a comprehensive plan built on
                a thorough understanding of your goals. Our advisors are
                supported by an internal team of experts dedicated entirely to
                identifying the best possible investment solutions for clients.
              </p>
              <p>
          ...
          >
            <div className="text d-flex flex-column col-xs-12 col-md-6 justify-content-center me-5">
              <h2 className="heading text-primary mb-3">
                Go Beyond Traditional Investment Management and Financial
                Planning
              </h2>
              <p className="mb-5">
                With a a strategic partnership of qualified advisors, attorneys,
                tax and investment professionals, we bring sophisticated
                strategies to optimize your financial life.
              </p>
              <p>
                <a href="#" className="btn btn-outline-primary py-2">
                  Read more
